...
folderPath = cd;
img = imread([folderPath '/NORMAL22_denoised.jpeg']);
...
path{1} = shortestpath(graph(adjMatrixMW,"lower"),1,numel(imgNew(:)));
...
path2{1} = shortestpath(graph(adjMatrixW,"lower"),1,numel(imgNew(:)));
