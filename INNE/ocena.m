...
XXX3 = readCSVAsVectors('AVG3.csv');
PSNR3 = XXX3.PSNRs_Avg(end-18:end);
Times3 = XXX3.Times_Avg(end-18:end);
SSIM3 = XXX3.SSIMs_Avg(end-18:end);
...
XXX11 = readCSVAsVectors('AVG11.csv');
PSNR11 = XXX11.PSNRs_Avg(end-18:end);
Times11 = XXX11.Times_Avg(end-18:end);
SSIM11 = XXX11.SSIMs_Avg(end-18:end);
...
XXX9 = readCSVAsVectors('AVG9.csv');
PSNR9 = XXX9.PSNRs_Avg(end-18:end);
Times9 = XXX9.Times_Avg(end-18:end);
SSIM9 = XXX9.SSIMs_Avg(end-18:end);
...
XXX7 = readCSVAsVectors('AVG7.csv');
PSNR7 = XXX7.PSNRs_Avg(end-18:end);
Times7 = XXX7.Times_Avg(end-18:end);
SSIM7 = XXX7.SSIMs_Avg(end-18:end);
...
XXX5 = readCSVAsVectors('AVG5.csv');
PSNR5 = XXX5.PSNRs_Avg(end-18:end);
Times5 = XXX5.Times_Avg(end-18:end);
SSIM5 = XXX5.SSIMs_Avg(end-18:end);
